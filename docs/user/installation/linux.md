...
Next steps: explore the [features tour](/docs/features) to
learn the core flow, or jump to [configuration](/docs/configuration)
to point Paneflow at your editor, shell, or theme. Hit a wall? The
[troubleshooting page](/docs/troubleshooting) covers the seven known
failure modes, Vulkan, Wayland, and PATH issues first.
