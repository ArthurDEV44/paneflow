...
You can scroll through hunks, compare additions and deletions, and toggle between a unified view and side by side. File headers stay pinned while you scroll and syntax highlighting runs on Tree-sitter.

## Compare branches without switching worktrees [#compare-branches-without-switching-worktrees]

The project view shows the diff for your current task. Multi-project mode gathers your open repos into tabs. Worktree mode lines sibling branches up side by side so you can read each one's progress without checking them out one by one.
...
The Diff view and agent review ship in Paneflow 0.3.7. Download the latest build, open a project, and select Diff in the sidebar.
