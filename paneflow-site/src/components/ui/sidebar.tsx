...
export function SidebarMenuSkeleton({
  ...
  // Random width between 50 to 90%. Math.random inside useMemo trips
  // react-hooks/purity in Next 16's ESLint config; the unstable result
  // is intentional here (skeleton variety) and bounded by empty deps.
